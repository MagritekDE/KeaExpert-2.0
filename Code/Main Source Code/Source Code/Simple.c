...
//			DisplayHTMLPage(msg.hwnd, "C:\\Users\\Craig\\Documents\\Visual Studio 2005\\Projects\\HTML Viewers\\cwebpage\\cwebpage_files\\simple\\Manipulating 1D plot files.htm");
//
//			// Show the window.
//			ShowWindow(msg.hwnd, nCmdShow);
//			UpdateWindow(msg.hwnd);
