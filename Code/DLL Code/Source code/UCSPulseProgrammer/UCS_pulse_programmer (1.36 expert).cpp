...
1.36 -------------------------------
  1. Addition of the skiponzero endskip commands to skip command
   ...
   Last modified 13 October 2021 CDE
...
short WaltzDecSetUp(DLLParameters* par,char *args)
{
   ...
   if(channel == "1" || channel == "1nb")
   {
      fprintf(fp,"\n\n;");
      fprintf(fp,"\n;***************************************************************************");
      fprintf(fp,"\n; Generate a ramped RF pulse (V2) setup code");
      fprintf(fp,"\n;"); 
   ...
   else if(channel == "2" || channel == "2nb")
   {
      fprintf(fp,"\n\n;");
      fprintf(fp,"\n;***************************************************************************");
      fprintf(fp,"\n; Generate a Ch-2 ramped RF pulse (V2) setup code");
      fprintf(fp,"\n;"); 
...
short WaltzEnd(DLLParameters* par,char *args)
{
   ...
   if(channel == "1")
   {
      ...
      fprintf(fp,"\n; Switch off channel 1 (TReX and IntRF)");
	   ...
	   fprintf(fp,"\n        and     #$FFBFF7,a");
	   fprintf(fp,"\n        move    a1,y:TTL                   ; Update TTL word");
	   fprintf(fp,"\n        move    a1,y:FPGA_TTL              ; Update TTL & RF");
