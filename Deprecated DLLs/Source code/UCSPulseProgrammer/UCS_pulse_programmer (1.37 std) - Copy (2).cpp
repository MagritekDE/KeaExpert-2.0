...
1.29 -------------------------------
   ...
   1. Version for the standard SW - no additional ch2 frequency setting in startcode or other cmds
 
 1.30 -------------------------------
   1. Expert version of 1.31
...
1.33 -------------------------------
   1. Test version with waltzdec and helper functions waltzstart, waltzend, waltzpulse waltzdecsetup
...
short IncTxFrequency(DLLParameters* par, char *args)
{
   ...
   CText incTx;
	...
	{
      Error(par->itfc,"Expecting 1 argument");
      return(ERR);
   }
   ...
   if(!fp)
   {
	...
	{
      Error(par->itfc,"Channel number should be 1");
      return(ERR);
   }
