...
class Variable
{
   ...
   // Set variable functions ****************
      ...
      void AssignList(char**,long);  
      void AssignStructure(Variable* struc);                        // Assign a structure                                                                   // Assign List character arrays
    ...
    // Get variable functions ****************
      ...
      double      GetDouble(void)    {return(*((double*)data));}    // Get real (double) number
      float       GetReal(void)      {return(*((float*)data));}     // Get real (float) number
      float       GetLong(void)      {return(*((long*)data));}      // Get long integer number
   ...
   // Get and set variable parameters
      ...
      long  GetType(void)         {return(type);}                   // Get the type of variable (STRING, FLOAT32 ...)
      ...
      bool  GetScope(void)        {return(scope);}                  // Does the variable have global, local or window scope?
